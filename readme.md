...
```
jabbala@JABBALA-M-MY32 ~ % kubectl get pods --all-namespaces
...
```
git clone https://github.com/jabbala/recognizing-digits-with-Kubeflow.git
```
...
* **Gunasekar Jabbala** - [jabbala](https://github.com/jabbala)
